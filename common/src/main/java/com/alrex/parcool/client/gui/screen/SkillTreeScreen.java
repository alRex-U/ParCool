...
public class SkillTreeScreen extends ParCoolTabletScreen {
    ...
    private void unlockSkill() {
        ...
        PacketHelper.sendToServer(
                ...
                new RequestUnlockActionPacket(selectedSkill.getActionEntry()),
                RequestUnlockActionPacket.HANDLER::encode
        );
    }
    ...
    private class ToggleActionButton extends ImageBySpriteButton {
        ...
        public void onPress() {
            ...
            PacketHelper.sendToServer(
                    ...
                    new EnableActionPacket(selectedSkill.getActionEntry(), !on),
                    EnableActionPacket.HANDLER::encode
            );
        }
