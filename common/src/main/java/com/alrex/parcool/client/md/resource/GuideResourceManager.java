...
public class GuideResourceManager extends SimplePreparableReloadListener<GuideResource> {
    ...
    public static void register() {
        ReloadListenerRegistry.register(
                PackType.CLIENT_RESOURCES, getInstance()
        );
    }


    @Override
    protected GuideResource prepare(ResourceManager resourceManager, ProfilerFiller profilerFiller) {
    ...
    @Override
    protected void apply(GuideResource markdownResource, ResourceManager resourceManager, ProfilerFiller profilerFiller) {
