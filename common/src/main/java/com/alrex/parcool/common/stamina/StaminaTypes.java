...
public class StaminaTypes {
    ...
    public static void onRegister(StaminaTypeRegistry registry) {
        registry.register(NONE_STAMINA);
        registry.register(PARCOOL_STAMINA);
        registry.register(HUNGER_STAMINA);
    }
}
