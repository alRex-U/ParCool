...
public class ParCoolSettingScreen extends Screen {
	...
	private final ButtonSet[] itemList = new ButtonSet[]{
			...
			new ButtonSet("action.name.flipping", CONFIG_CLIENT.canFlipping::set, CONFIG_CLIENT.canFlipping::get),
			new ButtonSet("can Frontward Dodge by double tapping a button", CONFIG_CLIENT.canFrontDodgeByDoubleTap::set, CONFIG_CLIENT.canFrontDodgeByDoubleTap::get),
	...
	public void render(PoseStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
		...
		FontUtil.drawCenteredText(p_230430_1_, "↓", window.getGuiScaledWidth() / 2, window.getGuiScaledHeight() - yOffset, 0x8888FF);
	}
