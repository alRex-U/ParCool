...
public class ParCool {
	...
	public ParCool() {
		...
		ModLoadingContext.get().registerConfig(ModConfig.Type.SERVER, ParCoolConfig.S_BUILDER.build());
		ModLoadingContext.get().registerConfig(ModConfig.Type.CLIENT, ParCoolConfig.Client.BUILT_SPEC);
	}
