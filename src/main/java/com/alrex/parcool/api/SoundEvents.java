...
public class SoundEvents {
    ...
    public static final RegistryObject<SoundEvent> VAULT = SOUNDS.register("parcool.action.vault", () -> VAULT_SOUND);
    public static final RegistryObject<SoundEvent> VERTICAL_WALL_RUN = SOUNDS.register("parcool.action.v_wall_run", () -> VERTICAL_WALL_RUN_SOUND);
    public static final RegistryObject<SoundEvent> HORIZONTAL_WALL_RUN = SOUNDS.register("parcool.action.h_wall_run", () -> HORIZONTAL_WALL_RUN_SOUND);
    public static final RegistryObject<SoundEvent> BREAKFALL_JUST_TIME = SOUNDS.register("parcool.action.breakfall.just", () -> BREAKFALL_JUST_TIME_SOUND);
    public static final RegistryObject<SoundEvent> ROLL = SOUNDS.register("parcool.action.breakfall.roll", () -> ROLL_SOUND);
    public static final RegistryObject<SoundEvent> SAFETY_TAP = SOUNDS.register("parcool.action.breakfall.tap", () -> SAFETY_TAP_SOUND);
    public static final RegistryObject<SoundEvent> CATLEAP = SOUNDS.register("parcool.action.catleap", () -> CATLEAP_SOUND);
    public static final RegistryObject<SoundEvent> WALL_JUMP = SOUNDS.register("parcool.action.wall_jump", () -> WALL_JUMP_SOUND);
    public static final RegistryObject<SoundEvent> CLING_TO_CLIFF = SOUNDS.register("parcool.action.cling_to_cliff.grab", () -> CLING_TO_CLIFF_SOUND);
    public static final RegistryObject<SoundEvent> CLING_TO_CLIFF_JUMP = SOUNDS.register("parcool.action.cling_to_cliff.jump", () -> CLING_TO_CLIFF_JUMP_SOUND);
    public static final RegistryObject<SoundEvent> HANG_DOWN = SOUNDS.register("action.hang_down.grab", () -> HANG_DOWN_SOUND);
    public static final RegistryObject<SoundEvent> HANG_DOWN_JUMP = SOUNDS.register("parcool.hang_down.jump", () -> HANG_DOWN_JUMP_SOUND);
    public static final RegistryObject<SoundEvent> SLIDE = SOUNDS.register("parcool.action.slide", () -> SLIDE_SOUND);
    public static final RegistryObject<SoundEvent> DODGE = SOUNDS.register("parcool.action.dodge", () -> DODGE_SOUND);
    public static final RegistryObject<SoundEvent> PARCOOL_ENABLE = SOUNDS.register("parcool.action.enable", () -> PARCOOL_ENABLE_SOUND);
    public static final RegistryObject<SoundEvent> PARCOOL_DISABLE = SOUNDS.register("parcool.action.disable", () -> PARCOOL_DISABLE_SOUND);
