...
public class ParCoolItems {
    ...
    public static final RegistryObject<Item> HOOK = ITEMS.register("hook", () -> new Item(new Item.Properties().tab(ParCoolItemGroup.INSTANCE)));
    public static final RegistryObject<GrapplingHookItem> GRAPPLING_HOOK = ITEMS.register("grappling_hook", () -> new GrapplingHookItem(new Item.Properties().tab(ParCoolItemGroup.INSTANCE).stacksTo(1).rarity(Rarity.UNCOMMON)));
