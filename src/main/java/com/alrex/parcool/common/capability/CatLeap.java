...
public class CatLeap implements ICatLeap{
    ...
    @Override
    public double getBoostValue(ClientPlayerEntity player) { return 0.49; }
    @Override
    public boolean isLeaping() { return leaping; }
    @Override
    public void setLeaping(boolean leaping) { this.leaping=leaping; }
