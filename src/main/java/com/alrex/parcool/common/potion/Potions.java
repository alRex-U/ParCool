...
public class Potions {
	...
	public static final RegistryObject<Potion> POOR_ENERGY_DRINK =
			POTIONS.register(
					"poor_energy_drink",
					() -> new Potion(
							new EffectInstance(com.alrex.parcool.api.Effects.INEXHAUSTIBLE.get(), 3600/*3 min*/),
	...
	public static final RegistryObject<Potion> ENERGY_DRINK =
			POTIONS.register(
					"energy_drink",
					() -> new Potion(
							new EffectInstance(com.alrex.parcool.api.Effects.INEXHAUSTIBLE.get(), 8400/*7 min*/)
					)
			);
