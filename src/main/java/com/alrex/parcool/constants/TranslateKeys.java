...
public class TranslateKeys {
	...
	public static final String MESSAGE_SERVER_DISABLE_INFINITE_STAMINA = "message.server.disable.infinity";
	public static final String COMMAND_SERVER_ALLOW_INFINITE_STAMINA = "command.server.send.allow.infinite";
	public static final String COMMAND_SERVER_NOT_ALLOW_INFINITE_STAMINA = "command.server.send.not.allow.infinite";
